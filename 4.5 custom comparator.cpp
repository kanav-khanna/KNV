//This thing is used alot for understanding DSA
//custom comperitor is just the programmer being able to tell the sort function how to sort the given array or vecotor  
#include <algorithm>
#include <iostream>
#include <vector>
